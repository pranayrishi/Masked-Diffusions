...
python3 -c "import json; d=json.load(open('${EVAL_FILE}')); assert d['results']; pairs=['{}={:.4%}'.format(r['strategy'], r['obs_accuracy']) for r in d['results']]; print('[phase_f ${IDX}] eval10k ok: ' + ', '.join(pairs))"
